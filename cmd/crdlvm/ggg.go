...
//     lvmv1 "k8s-crd-lvmnodestorage/pkg/client/listers/control/v1"
...
// // NodeLVMController is responsible for performing actions dependent upon a namespace phase
// type NodeLVMController struct {
//     kubeclient kubernetes.Interface
//     lvmclient  lvmclientset.Interface
// 	// lister that can list namespaces from a shared cache
// 	lister lvmv1.NodeLVMStorageLister
...
// // NewNodeLVMControllerController creates a new NamespaceController
// func NewNodeLVMControllerController(
// 	kubeClient kubernetes.Interface,
// 	lvmclient lvmclientset.Interface,
// 	discoverResourcesFn func() ([]*metav1.APIResourceList, error),
// 	namespaceInformer coreinformers.NamespaceInformer,
// 	resyncPeriod time.Duration,
// 	finalizerToken v1.FinalizerName) *NodeLVMController {

// 	// create the controller so we can inject the enqueue function
// 	nodeLVMController := &NodeLVMController{
